...
namespace Klyte.Commons.UI
{
    public class TLMWorkerChartPanel : UICustomControl
    {
        ...
        {
            KlyteUiUtils.CreateUIElement(out m_agesChartPanel, m_parent);
            ...
            KlyteUiUtils.CreateUIElement(out UIPanel pieLegendPanel, m_agesChartPanel.transform);
            ...
            KlyteUiUtils.CreateUIElement(out m_workplaceChart, m_agesChartPanel.transform);
            ...
            KlyteUiUtils.CreateUIElement(out m_workersChart, m_workplaceChart.transform);
        ...
        private UILabel CriaFatiaELegenda(Color c, UIRadialChartExtended chart, UIPanel legendPanel = null, string localeID = "", float offsetY = 0)
        {
            ...
            if (legendPanel != null)
            {
                KlyteUiUtils.CreateUIElement(out UIPanel legendItemContainer, legendPanel.transform);
                ...
                KlyteUiUtils.CreateUIElement(out UILabel legendColor, legendItemContainer.transform);
                ...
                legendColor.color = c;
                KlyteUiUtils.CreateUIElement(out UILabel legendName, legendItemContainer.transform);
